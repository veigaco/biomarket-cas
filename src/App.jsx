...
export default function App() {
  ...
  const { stocks, marketState, regime, phase, periodReturns, logs, connectionStatus } = useMarketStore();
    ...
    return (
      <div className="fixed inset-0 bg-slate-950 flex flex-col items-center justify-center gap-4">
        <div className="text-white text-2xl font-bold">
          {connectionStatus === 'connecting' && 'Connecting to market...'}
        ...
        <div className="text-slate-400 text-sm">
          ...
          {connectionStatus === 'connected' && 'Receiving initial snapshot'}
          {connectionStatus === 'error' && 'Please ensure backend is running at localhost:8000'}
